...
class CreditService(
  ...
  override fun save(credit: Credit): Credit {
    ...
    this.validateMaxNumberOfInstallments(credit.numberOfInstallments)
    credit.apply {
  ...
  private fun validateMaxNumberOfInstallments(numberOfInstallments: Int) {
    if (numberOfInstallments > 48) throw BusinessException("Number of installments must be less than or equal to 48.")
  }
}
